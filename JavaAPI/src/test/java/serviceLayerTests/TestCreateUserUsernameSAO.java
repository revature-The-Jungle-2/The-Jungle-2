...
public class TestCreateUserUsernameSAO {
    ...
    public void createUserUsernameBlankInputUsernameNegative() {
        User newUser = new User(1, "Lillith", "Thompson", "lilly6@gmail.com", "", "BearLuna", "There's not too much to know", 1574121600000L, ".gif");
        userServiceSAOImp.createNewUserService(newUser);

    }

    @Test(expectedExceptions = UnallowedSpaces.class, expectedExceptionsMessageRegExp = "No spaces allowed in username or password")
    public void createUserUsernameBlankInputUsername() {
    ...
    public void createUserUsernameSpacesNegative() {
        User newUser = new User(1, "Lillith", "Thompson", "lilly" + f + "@gmail.com", "Lil", "Bear Luna", "There's not too much to know", 1574121600000L, ".gif");
        userServiceSAOImp.createNewUserService(newUser);
    ...
    public void createUserUsernameZero() {
        User newUser = new User(1, "Lillith", "Thompson", "lilly" + f + "@gmail.com", "0", "Bear Luna", "There's not too much to know", 1574121600000L, ".gif");
        userServiceSAOImp.createNewUserService(newUser);
