...
class GroupDAOImp(GroupDAO):
    ...
    def create_group(self, group: Group):
        ...
        sql = "select * from p3.group_table where group_name = %(group_name)s;"
        cursor = connection.cursor()
        ...
        # create the group
        sql = 'insert into p3.group_table values(default, %s, %s, %s, %s) returning group_id'
        cursor = connection.cursor()
        ...
        sql = "insert into p3.group_member_junction_table values(%s, %s) returning group_id, user_id"
        cursor = connection.cursor()
    ...
    def join_group(self, group_id: int, user_id: int):
        ...
        sql = "select * from p3.group_table where group_id = %(group_id)s;"
        cursor = connection.cursor()
